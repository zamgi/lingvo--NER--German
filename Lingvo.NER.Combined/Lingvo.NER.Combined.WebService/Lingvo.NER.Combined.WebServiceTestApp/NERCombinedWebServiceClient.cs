...
namespace Lingvo.NER.Combined.WebService
{
    ...
    /// 
    /// </summary>
    internal sealed class NERCombinedWebServiceClient
    {
        private HttpClient _HttpClient;
        private Uri        _RunUrl;
        private JsonSerializerOptions _JsonSerializerOptions;
        public NERCombinedWebServiceClient( HttpClient httpClient, string baseUrl )
        {
            _HttpClient = httpClient;

            baseUrl = baseUrl.TrimEnd( '/' );
            _RunUrl = new Uri( $"{baseUrl}/{WebApiConsts.NERCombined.RoutePrefix}/{WebApiConsts.NERCombined.Run}" );

            _JsonSerializerOptions = new JsonSerializerOptions( JsonSerializerDefaults.General ) { PropertyNamingPolicy = JsonNamingPolicy.CamelCase, DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingNull, /*IgnoreNullValues = true,*/ };
