...
namespace Lingvo.NER.Rules.sentSplitting
{
    ...
    unsafe public class SentSplitterModel : IDisposable
    {
        ...
        ///// 
        ///// </summary>
        //internal readonly struct dictionary_t< TValue >
        //{
        ...
        //    public Dictionary< string, TValue > Values                     { [M(O.AggressiveInlining)] get; }
        //    public int                          ValuesMaxLength            { [M(O.AggressiveInlining)] get; }
        //    public int                          ValuesMinLength            { [M(O.AggressiveInlining)] get; }
        //    public int                          DiffBetweenMixAndMaxLength { [M(O.AggressiveInlining)] get; }
        //}
    ...
    public sealed class SentSplitterConfig : IDisposable
    {
        ...
        public SentSplitterModel Model             { get; set; }
