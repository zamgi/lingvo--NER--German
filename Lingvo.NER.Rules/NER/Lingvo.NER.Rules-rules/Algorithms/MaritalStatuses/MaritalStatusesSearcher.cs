...
namespace Lingvo.NER.Rules.MaritalStatuses
{
    ...
    ///
    /// </summary>
    internal sealed class MaritalStatusesSearcher
    {
        #region [.ctor().]
        private IWordsChainDictionary _WordsChainDict;
        public MaritalStatusesSearcher(IWordsChainDictionary wcd) => _WordsChainDict = wcd;
        #endregion
    ...
    /// 
    /// </summary>
    internal static class MaritalStatusesExtensions
    {
