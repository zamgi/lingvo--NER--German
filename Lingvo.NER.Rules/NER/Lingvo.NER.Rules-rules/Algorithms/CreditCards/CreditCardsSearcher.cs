...
using ngram_t = Lingvo.NER.Rules.CreditCards.CreditCardsSearcher.ngram_t;
...
namespace Lingvo.NER.Rules.CreditCards
{
    ...
    ///
    /// </summary>
    internal static class CreditCardsSearcher
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        private sealed class Model
        {
            ...
            {
                //Credit Card numbers for our Analyzer consist of 13-16 digits.
                //There exist variants with up to 19 digits, but they are not common in Europe.

                //'1234567890123' - '1234567890123456'
                for ( var len = 13; len <= 16; len++ )
                {
                    yield return (new[] { ngram_t.ValidNumber( len ) });
                }

                //'5747 0047 0167 1-1234'
                for ( var len = 1; len <= 4; len++ )
                {                    
                    yield return (new[] { ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( len ) });
                }

                #region comm. [.len = 12.]
                ////'574700 470167'
                //yield return (new[] { ngram_t.ValidNumber( 6 ), ngram_t.ValidNumber( 6 ) });
                ////'5747 0047 0167'
                //yield return (new[] { ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ) });
                ////'574 700 470 167'
                //yield return (new[] { ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ) });
                #endregion

                #region [.len = 15.]
                //'57470 04701 67123'
                yield return (new[] { ngram_t.ValidNumber( 5 ), ngram_t.ValidNumber( 5 ), ngram_t.ValidNumber( 5 ) });
                //'574 700 470 167 123'
                yield return (new[] { ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ), ngram_t.ValidNumber( 3 ) });
                #endregion

                #region [.len = 16.]
                //'57470047 01671234'
                yield return (new[] { ngram_t.ValidNumber( 8 ), ngram_t.ValidNumber( 8 ) });
                //'5747 0047 0167 1234'
                yield return (new[] { ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ), ngram_t.ValidNumber( 4 ) });
                #endregion

                #region comm. [.len = 18.]
                ////'574700471 016712342'
                //yield return (new[] { ngram_t.ValidNumber( 9 ), ngram_t.ValidNumber( 9 ) });
                ////'574700 470167 123478'
                //yield return (new[] { ngram_t.ValidNumber( 6 ), ngram_t.ValidNumber( 6 ), ngram_t.ValidNumber( 6 ) });
                #endregion
            }
        }
        #endregion
        ...
        static CreditCardsSearcher() => _Root = TreeNode.BuildTree( Model.GetNgrams() );
        #endregion
    ...
    /// 
    /// </summary>
    internal static class CreditCardsSearcherExtensions
    {
