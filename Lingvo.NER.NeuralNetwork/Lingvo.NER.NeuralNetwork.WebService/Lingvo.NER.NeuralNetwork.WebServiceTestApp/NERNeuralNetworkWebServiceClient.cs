...
namespace Lingvo.NER.NeuralNetwork.WebService
{
    ...
    /// 
    /// </summary>
    internal sealed class NERNeuralNetworkWebServiceClient
    {
        private HttpClient _HttpClient;
        private Uri _RunUrl;
        private JsonSerializerOptions _JsonSerializerOptions;
        public NERNeuralNetworkWebServiceClient( HttpClient httpClient, string baseUrl )
        {
            _HttpClient = httpClient;

            baseUrl = baseUrl.TrimEnd( '/' );
            _RunUrl = new Uri( $"{baseUrl}/{WebApiConsts.NNER.RoutePrefix}/{WebApiConsts.NNER.Run}" );
